...
class ResourceProvider(object):
    ...
    NC_TEMPERATURE_NORMAL = 'TEMP_NORMAL'
    NC_HUMIDITY_HIGHER = 'HUMI_HIGHER'
    NC_HUMIDITY_NORMAL = 'HUMI_NORMAL'
    NC_MOTION_DETECTED = 'MOTION_DETECTED'
    NC_GAS_ALARM_ON = 'GAS_ALARM_ON'
    NC_GAS_ALARM_OFF = 'GAS_ALARM_OFF'

    # animations codes
    AC_ACTIVATE_ALARM = 'ACTIVATE_ALARM'
    AC_DEACTIVATE_ALARM = 'DEACTIVATE_ALARM'
    AC_MOTION_ENABLED = 'MOTION_ENABLED'
    AC_MOTION_DISABLED = 'MOTION_DISABLED'
    AC_TEMPERATURE_WARNING_ON = 'TEMP_WARNING_ON'
    AC_TEMPERATURE_WARNING_OFF = 'TEMP_WARNING_OFF'
    AC_HUMIDITY_WARNING_ON = 'HUMIDITY_WARNING_ON'
    AC_HUMIDITY_WARNING_OFF = 'HUMIDITY_WARNING_OFF'
